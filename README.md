...
## Abstract
Crop wild relatives and landraces represent locally adapted germplasm, enabling landscape genomic studies to identify genomic signatures of environmental adaptation. The derived information from such studies can be used to evaluate cultivar’s adaptive value. This approach can represent an advantageous opportunity particularly for perennial crops where multi-location field trials to test specific cultivar or new breeding clone adaptations are costly and time-consuming.
